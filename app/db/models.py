...
from sqlalchemy import Column, String, Text, Float, DateTime, ForeignKey, JSON, UniqueConstraint
...
class Idea(Base):
    ...
    blueprint = relationship("MVPBlueprint", back_populates="idea", uselist=False, cascade="all, delete-orphan")
...
class MVPBlueprint(Base):
    ...
    package = relationship("MVPPackage", back_populates="blueprint", uselist=False, cascade="all, delete-orphan")
